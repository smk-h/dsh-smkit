...
export const CUSTOM_SETTINGS_LOCALE_EN: LocaleDict = {
  ...
  "detecting": "Checking…",
  "detectImage": "Check result: this model takes text and images",
  "detectTextOnly": "Check result: this model takes text only",
  ...
  "discoverUnsupported": "This route has no model listing to ask; tick the boxes by hand.",
  "discoverFailed": "The capability check got no usable answer; try again later or tick the boxes by hand.",
  "discoverNoModel": "The model listing does not report this model's inputs; tick the boxes by hand.",
