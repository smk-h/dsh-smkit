 ...
 * confirmation dialog's two buttons. Business copy stays in its feature's
 * namespace (`mcp`, `session-delete`), so a shared label like "删除" has exactly
 * one home instead of one copy per feature.
 */
